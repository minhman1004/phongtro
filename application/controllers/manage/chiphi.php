...
class Users extends CI_Controller {
	public function index() {
		$dsUsers = $this->Chiphi->getAllChiphi();
	...
	public function updateChiphi() {
		$data['MANT'] = $this->input->post('MANT');
		$data['GiaNuoc'] = $this->input->post('hoten');
		$data['GiaDien'] = $this->input->post('email');
		$data['GiaGXe'] = $this->input->post('sdt');
		$data['GiaWifi'] = $this->input->post('cmnd');
		$data['GiaRac'] = $this->input->post('ngaysinh');
		$result = $this->Chiphi->editChiphi($data);
