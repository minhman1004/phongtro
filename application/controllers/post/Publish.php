...
class Publish extends CI_Controller {
    ...
    Public function dangtin()
    {
        ...
        $data['tieude'] = $this->input->post('tieude');
        ...
        $data['ttp'] = $this->input->post('ttp');
        $data['px'] = $this->input->post('px');
        $data['qh']= $this->input->post('qh');
        $data['dccx']= $this->input->post('dccx');
        $data['mota']= $this->input->post('mota');
        $data['hinhanh']= $this->input->post('hinhanh');
